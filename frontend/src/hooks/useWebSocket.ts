...
interface UseWebSocketReturn {
    ...
    sendContext: (context: { user_id?: string; profile_id?: string; resume_text: string; star_stories: any[]; talking_points: any[]; qa_pairs?: any[] }) => void;
...
export function useWebSocket(options: UseWebSocketOptions): UseWebSocketReturn {
    ...
    const sendContext = useCallback((context: { user_id?: string; profile_id?: string; resume_text: string; star_stories: any[]; talking_points: any[]; qa_pairs?: any[] }) => {
        if (wsRef.current?.readyState === WebSocket.OPEN) {
